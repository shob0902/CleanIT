...
const ALLOWED_EMPLOYEE_PHONES = ['9009618612']; // Example employee phone numbers

async function saveEmployeeData(data: EmployeeData): Promise<void> {
  try {
...
export default function EmployeeLoginScreen() {
  ...
  const handleSendOTP = () => {
    ...
    if (!ALLOWED_EMPLOYEE_PHONES.includes(phone)) {
      Alert.alert('Access Denied', 'This phone number is not registered as an employee');
      return;
    }
    ...
    if (otp === generatedOTP) {
      try {
        ...
        await saveEmployeeData({
          fullName: "Mayank Kapoor",
          employeeId: "EMP001",
          phone: phone,
          role: "Cleaning Staff"
        });
        
        // Navigate to employee home screen
            ...
            <View style={styles.overlay}>
              <View style={styles.content}>
                <View style={styles.header}>
                  <Image
                    source={require('../../assets/images/em-log.png')}
